...
export class TarefaRepositoryLocalStorage implements IRepositorioTarefa, IRepositorioSerializavel {
    ...
    public descricaoDuplicado(descricao: string): boolean{
        if(this.tarefas.find(x => x.descricao === descricao) != undefined)
        return true;
        return false;
   }
